  ...
  [414],
  {
      ...
      var i = n.createContext({}),
        ...
        s = n.forwardRef(function (e, t) {
          var r = e.components,
            ...
            s = u(r),
            m = o,
            d = s["".concat(i, ".").concat(m)] || s[m] || f[m] || a;
          return r
            ? n.createElement(d, c(c({ ref: t }, l), {}, { components: r }))
    ...
    3123: function (e, t, r) {
      ...
      var n = r(7462),
        ...
        a = (r(7294), r(3905)),
        c = ["components"],
        p = { title: "Markdown page example" },
        i = "Markdown page example",
        u = {
          type: "mdx",
          permalink: "/react-native-echarts-pro-docs/markdown-page",

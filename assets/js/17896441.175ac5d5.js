...
(self.webpackChunkreact_native_echarts_pro_docs =
  ...
  [918],
  {
    2179: function (e, t, a) {
      ...
      function b(e) {
        var t = v[e.versionMetadata.banner];
      ...
      function E(e) {
        var t,
          a = e.className,
          r = e.versionMetadata,
          i = (0, o.Z)().siteConfig.title,
          s = (0, d.gA)({ failfast: !0 }).pluginId,
          c = (0, u.J)(s).savePreferredVersionName,
          m = (0, d.Jo)(s),
          v = m.latestDocSuggestion,
          E = m.latestVersionSuggestion,
          g =
            null != v
              ? v
              : (t = E).docs.find(function (e) {
        ...
        return n.createElement(
          ...
          n.createElement(
            "div",
            null,
            n.createElement(b, { siteTitle: i, versionMetadata: r })
          ),
          n.createElement(
            "div",
      ...
      function _(e) {
        ...
        return n.createElement(
          "span",
          { className: u.kM.common.lastUpdated },
          n.createElement(
            i.Z,
            {
              ...
              values: {
                atDate:
                  t && a
                    ...
                    : "",
                byUser: l ? n.createElement(N, { lastUpdatedBy: l }) : "",
              },
            },
      ...
      function C(e) {
        return n.createElement(
          ...
          {
            className: (0, l.Z)(
              u.kM.docs.docFooterTagsRow,
              "row margin-bottom--sm"
            ),
          },
          n.createElement("div", { className: "col" }, n.createElement(k.Z, e))
        );
      }
      function U(e) {
        var t = e.editUrl,
        ...
        return n.createElement(
          "div",
          { className: (0, l.Z)(u.kM.docs.docFooterEditMetaRow, "row") },
          n.createElement(
            "div",
            { className: "col" },
            t && n.createElement(Z.Z, { editUrl: t })
          ),
          n.createElement(
            "div",
            { className: (0, l.Z)("col", L) },
            (a || r) &&
              n.createElement(_, {
                lastUpdatedAt: a,
      ...
      function T(e) {
        ...
        return o || m
          ? n.createElement(
              "footer",
              { className: (0, l.Z)(u.kM.docs.docFooter, "docusaurus-mt-lg") },
              o && n.createElement(C, { tags: c }),
              m &&
                n.createElement(U, {
                  editUrl: a,
                  lastUpdatedAt: r,
      ...
      var y = a(1575),
        M = "tocCollapsible_jdIR",
        w = "tocCollapsibleButton_Fzxq",
        A = "tocCollapsibleContent_MpvI",
        x = "tocCollapsibleExpanded_laf4",
        H = a(5002);
      function B(e) {
        var t = e.toc,
          a = e.className,
          r = e.minHeadingLevel,
          s = e.maxHeadingLevel,
          c = (0, u.uR)({ initialState: !0 }),
          o = c.collapsed,
          m = c.toggleCollapsed;
        return n.createElement(
          "div",
          { className: (0, l.Z)(M, !o && x, a) },
          n.createElement(
            "button",
            { type: "button", className: (0, l.Z)("clean-btn", w), onClick: m },
            n.createElement(
              i.Z,
              {
          ...
          n.createElement(
            u.zF,
            { lazy: !0, className: A, collapsed: o },
            n.createElement(H.Z, {
              toc: t,
              minHeadingLevel: r,
              maxHeadingLevel: s,
      ...
      var D = a(9649),
        I = "docItemContainer_vinB",
        S = "docItemCol_DM6M",
        V = "tocMobile_TmEX",
        P = { breadcrumbsContainer: "breadcrumbsContainer_Xlws" },
        F = a(4996);
      function O(e) {
        var t = e.children,
          a = e.href,
        ...
        return a
          ...
          : n.createElement("span", { className: l, itemProp: "item name" }, t);
      }
      function R(e) {
        var t = e.children,
          a = e.active,
      ...
      function z() {
        ...
        return n.createElement(
          ...
          n.createElement(
            m.Z,
            {
              className: (0, l.Z)("breadcrumbs__link", P.breadcrumbsItemLink),
              href: e,
            },
            "\ud83c\udfe0"
          )
        ...
        return e
          ? n.createElement(
              ...
              n.createElement(
                ...
                t && n.createElement(z, null),
                e.map(function (t, a) {
                  return n.createElement(
                    R,
                    { key: a, active: a === e.length - 1, index: a },
                    n.createElement(
                      O,
                      { href: a < e.length - 1 ? t.href : void 0 },
                      t.label
                    )
                  );
                })
      ...
      function Q(e) {
        var t = e.content,
          ...
          r = t.frontMatter,
          i = r.hide_title,
          s = r.hide_table_of_contents,
          o = r.toc_min_heading_level,
          m = r.toc_max_heading_level,
          d = a.title,
          v = !i && void 0 === t.contentTitle,
          b = (0, u.iP)(),
          p = !s && t.toc && t.toc.length > 0,
          E = p && ("desktop" === b || "ssr" === b);
        return n.createElement(
          "div",
          { className: "row" },
              ...
              n.createElement(
                ...
                p &&
                  n.createElement(B, {
                    ...
                    minHeadingLevel: o,
                    maxHeadingLevel: m,
                    className: (0, l.Z)(u.kM.docs.docTocMobile, V),
                  }),
                n.createElement(
                  "div",
                  { className: (0, l.Z)(u.kM.docs.docMarkdown, "markdown") },
                  v &&
                    n.createElement(
                      "header",
                      null,
                      n.createElement(D.Z, { as: "h1" }, d)
                    ),
                  n.createElement(J.Z, null, n.createElement(t, null))
                ),
                n.createElement(T, e)
              ),
              n.createElement(c, { previous: a.previous, next: a.next })
            )
          ),
          E &&
            n.createElement(
              ...
              n.createElement(y.Z, {
                ...
                minHeadingLevel: o,
                maxHeadingLevel: m,
                className: u.kM.docs.docTocDesktop,
              })
            )
        );
      }
      ...
      function u(e) {
        ...
        return n.createElement(
          "a",
          {
            ...
            className: d.kM.common.editThisPage,
          },
    ...
    5002: function (e, t, a) {
      ...
      function o(e) {
        var t = e.toc,
          ...
          o =
            void 0 === a
              ...
              : a,
          m = e.linkClassName,
          d = void 0 === m ? "table-of-contents__link" : m,
          ...
          E = (0, l.Z)(e, s),
          g = (0, i.LU)(),
          h = null != b ? b : g.tableOfContents.minHeadingLevel,
          f = null != p ? p : g.tableOfContents.maxHeadingLevel,
          N = (0, i.b9)({ toc: t, minHeadingLevel: h, maxHeadingLevel: f }),
          _ = (0, r.useMemo)(
            function () {
              if (d && v)
                return {
        ...
        return (
          ...
          r.createElement(
            c,
            (0, n.Z)({ toc: N, className: o, linkClassName: d }, E)
          )
        );
      }
    },
          ...
          n.createElement(
            ...
            t.map(function (e) {
              ...
              return n.createElement(
                "li",
                { key: a, className: c },
                n.createElement(i.Z, { name: t, permalink: a })
              );
            })
          )
        );

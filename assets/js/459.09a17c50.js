  ...
  [459],
  {
      ...
      var i = r.createContext({}),
        ...
        m = r.forwardRef(function (e, t) {
          var n = e.components,
            ...
            m = s(n),
            d = o,
            y = m["".concat(i, ".").concat(d)] || m[d] || p[d] || a;
          return n
            ? r.createElement(y, c(c({ ref: t }, u), {}, { components: n }))
            : r.createElement(y, c({ ref: t }, u));
        });
      function d(e, t) {
        var n = arguments,
          o = t && t.mdxType;
    ...
    9649: function (e, t, n) {
      ...
      var r = n(7462),
        ...
        u = "anchorWithHideOnScrollNavbar_R0VQ",
        p = ["as", "id"],
        m = ["as"];
      function d(e) {
        var t = e.as,
          n = e.id,
          m = (0, o.Z)(e, p),
          d = (0, i.LU)().navbar.hideOnScroll;
        return n
          ? a.createElement(
              t,
              (0, r.Z)({}, m, {
                className: (0, c.Z)("anchor", d ? u : s),
                id: n,
              }),
              m.children,
              a.createElement(
      ...
      function y(e) {
        var t = e.as,
          n = (0, o.Z)(e, m);
        return "h1" === t
          ? a.createElement("h1", (0, r.Z)({}, n, { id: void 0 }), n.children)
          : a.createElement(d, (0, r.Z)({ as: t }, n));
      }
    },
    7459: function (e, t, n) {
      n.d(t, {
      ...
      var s = n(6010),
        ...
        p = { Prism: n(7410).default, theme: u };
      function m(e, t, n) {
        return (
          t in e
            ? Object.defineProperty(e, t, {
      ...
      var y = /\r\n|\r|\n/,
        ...
        g = function (e, t) {
          ...
          return (
            (o.root = n), (o.plain = d({}, n, { backgroundColor: null })), o
          );
        };
      function v(e, t) {
        var n = {};
      ...
      var b = (function (e) {
          function t() {
            for (var t = this, n = [], r = arguments.length; r--; )
              n[r] = arguments[r];
            e.apply(this, n),
              m(this, "getThemeDict", function (e) {
                if (
                  void 0 !== t.themeDict &&
                  e.theme === t.prevTheme &&
              ...
              m(this, "getLineProps", function (e) {
                var n = e.key,
                  r = e.className,
                  o = e.style,
                  a = d({}, v(e, ["key", "className", "style", "line"]), {
                ...
                return (
                  ...
                  void 0 !== o &&
                    (a.style = void 0 !== a.style ? d({}, a.style, o) : o),
                  void 0 !== n && (a.key = n),
                  r && (a.className += " " + r),
                  a
                );
              }),
              m(this, "getStyleForToken", function (e) {
                var n = e.types,
                  r = e.empty,
                  o = n.length,
              ...
              m(this, "getTokenProps", function (e) {
                var n = e.key,
                  r = e.className,
                  o = e.style,
                  a = e.token,
                  c = d({}, v(e, ["key", "className", "style", "token"]), {
                ...
                return (
                  void 0 !== o &&
                    (c.style = void 0 !== c.style ? d({}, c.style, o) : o),
                  void 0 !== n && (c.key = n),
                  r && (c.className += " " + r),
                  c
                );
              }),
              m(this, "tokenize", function (e, t, n, r) {
                    ...
                    for (; (a = r[c]++) < o[c]; ) {
                      ...
                      if (
                        ...
                        for (var g = 1; g < d; g++)
                          f(l),
                            i.push((l = [])),
                            l.push({ types: u, content: m[g] });
                      } else
                        c++, t.push(u), n.push(s), r.push(0), o.push(s.length);
                    }
      ...
      var O = n(5999),
        N = "copyButton_eDfN",
        T = "copyButtonCopied_ljy5",
        Z = "copyButtonIcons_W9eQ",
        j = "copyButtonIcon_XEyF",
        _ = "copyButtonSuccessIcon_i9w9";
      function w(e) {
        var t = e.code,
          n = (0, r.useState)(!1),
          o = n[0],
        ...
        return (
          ...
          r.createElement(
            "button",
            {
              ...
              className: (0, s.Z)(N, "clean-btn", o && T),
              onClick: l,
            },
            r.createElement(
              "span",
              { className: Z, "aria-hidden": "true" },
              r.createElement(
                "svg",
                { className: j, viewBox: "0 0 24 24" },
      ...
      var x = "codeBlockContainer_I0IT",
        P = "codeBlockContent_wNvx",
        C = "codeBlockTitle_BvAR",
        B = "codeBlock_jd64",
        L = "codeBlockStandalone_csWH",
        A = "codeBlockLines_mRuA";
      function S(e) {
        var t,
          n = e.children,
          o = e.className,
              ...
              return r.createElement(
                "pre",
                {
                  ...
                  className: (0, s.Z)(
                    ...
                    x,
                    c,
                    E.kM.common.codeBlock
                  ),
                  style: o,
                },
                r.createElement("code", { className: A }, n)
              );
            }
          );
        var v = Array.isArray(n) ? n.join("") : n,
          b =
            null != (t = null != u ? u : (0, E.Vo)(c)) ? t : m.defaultLanguage,
          O = (0, E.nZ)(v, l, b),
          N = O.highlightLines,
          T = O.code;
        return r.createElement(
            ...
            return r.createElement(
              "div",
              {
                className: (0, s.Z)(
                  ...
                  c,
                  ((t = {}),
                  (t["language-" + b] = b && !c.includes("language-" + b)),
                  t),
                  E.kM.common.codeBlock
                ),
              },
              h && r.createElement("div", { style: o, className: C }, h),
              r.createElement(
                "div",
                { className: P, style: o },
                r.createElement(
                  "pre",
                  { tabIndex: 0, className: (0, s.Z)(n, B, "thin-scrollbar") },
                  r.createElement(
                    "code",
                    { className: A },
                    l.map(function (e, t) {
      ...
      function V(e) {
        ...
        return r.createElement(
          E.PO,
          (0, a.Z)({}, t, {
            className: (0, s.Z)("alert alert--info", I, t.className),
          })
        );
      }
      var H = n(9649);
      function R(e) {
        return r.createElement(H.Z, e);
      }
      var z = "img_E7b_";
      var M = {
        head: function (e) {
          var t = r.Children.map(e.children, function (e) {
            return (function (e) {
              ...
              if (
                ...
                var o = e.props,
                  a = (o.mdxType, o.originalType, (0, c.Z)(o, i));
        ...
        details: function (e) {
          var t = r.Children.toArray(e.children),
            n = t.find(function (e) {
              ...
              return (
                "summary" ===
                (null == e || null == (t = e.props) ? void 0 : t.mdxType)
              );
            }),
            o = r.createElement(
              r.Fragment,
          ...
          return r.createElement(V, (0, a.Z)({}, e, { summary: n }), o);
        },
        ul: function (e) {
          return r.createElement(
            "ul",
            (0, a.Z)({}, e, {
              className:
                ...
                (0, s.Z)(
                  t,
                  (null == t ? void 0 : t.includes("contains-task-list")) &&
        ...
        img: function (e) {
          return r.createElement(
            ...
            (0, a.Z)({ loading: "lazy" }, e, {
              className: ((t = e.className), (0, s.Z)(t, z)),
            })
          );
          var t;
        },
        h1: function (e) {
          return r.createElement(R, (0, a.Z)({ as: "h1" }, e));
        },
        h2: function (e) {
          return r.createElement(R, (0, a.Z)({ as: "h2" }, e));
        },
        h3: function (e) {
          return r.createElement(R, (0, a.Z)({ as: "h3" }, e));
        },
        h4: function (e) {
          return r.createElement(R, (0, a.Z)({ as: "h4" }, e));
        },
        h5: function (e) {
          return r.createElement(R, (0, a.Z)({ as: "h5" }, e));
        },
        h6: function (e) {
          return r.createElement(R, (0, a.Z)({ as: "h6" }, e));
        },
      };
      function F(e) {
        var t = e.children;
        return r.createElement(o.Zo, { components: M }, t);
      }
    },
  },
]);
